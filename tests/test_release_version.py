...
breaking change straight to the next major. At `v0.10.2` with the `fix(output)!` from #300 merged, that
answer is `v1.0.0` -- measured on the review machine, not predicted -- and `v1.x` declares a stable API this package is not
ready to promise.
